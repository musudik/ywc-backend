...
interface Request extends ExpressRequest {
  currentUser?: any; // Use any to bypass type checking for tests
}
...
describe('AuthController', () => {
  ...
  describe('verifyEmail', () => {
    it('should return 400 if token is missing', async () => {
      ...
      await authController.verifyEmail(mockRequest as any, mockResponse as Response);
  ...
  describe('forgotPassword', () => {
    it('should return 400 if email is missing', async () => {
      ...
      await authController.forgotPassword(mockRequest as any, mockResponse as Response);
  ...
  describe('resetPassword', () => {
    it('should return 400 if required fields are missing', async () => {
      ...
      await authController.resetPassword(mockRequest as any, mockResponse as Response);
  ...
  describe('getCurrentUser', () => {
    ...
    it('should return user profile if authenticated', async () => {
      mockRequest.currentUser = {
        ...
        firebaseUid: 'firebase-123',
        password: 'hashed-password', // Include password field needed by Prisma
        role: {
          id: '456',
          name: 'CLIENT',
          description: null,
